...
public class AddTwoNumbers {
    ...
    public static void main(String[] args) {
        ...
        ListNode listNode3 = NodeUtils.buildListNode(1, 3, 4);
        ListNode listNode4 = NodeUtils.buildListNode(5, 6, 4);
        ...
        ListNode listNode = NodeUtils.buildListNode(2, 7, 3);
        ListNode listNode2 = NodeUtils.buildListNode(1, 6);
        ListNode resultListNode = addTwoNumbers.addTwoNumbers3(listNode, listNode2);
        AssertUtils.assertListNode(resultListNode, 3, 3, 4);



        ListNode l1 = NodeUtils.buildListNode(2, 4, 3);
        ListNode l2 = NodeUtils.buildListNode(5, 6, 4);
