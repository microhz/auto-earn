...
public class PailingDromeLinkedList {
    ...
    public static void main(String[] args) {
        ListNode listNode = NodeUtils.buildListNode(1, 2, 2, 1);
        ...
        Assert.assertTrue(! pailingDromeLinkedList.isPalindrome2(NodeUtils.buildListNode(1, 1, 2, 1)));

        Assert.assertTrue(pailingDromeLinkedList.isPalindrome2(NodeUtils.buildListNode(1, 0, 1)));
